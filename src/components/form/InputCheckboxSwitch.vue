...
.input-checkbox-switch {
	...
	--input-checkbox-dot-color:var(--tertiary);
	--input-checkbox-icon-color: color-mix(in srgb, var(--input-checkbox-dot-color), var(--foreground) 80%);
	...
	&__control-container {
		...
		&:has(:checked)~* {
			--input-checkbox-dot-x: calc(var(--input-checkbox-width) - var(--input-checkbox-dot-size) - (var(--input-checkbox-space) * 2));
			--input-checkbox-dot-color: var(--input-checkbox-dot-color--active, var(--primary));
			--input-checkbox-dot-background-image: #{form.line-gradient( to right, var(--input-checkbox-icon-color, currentColor), 2px, end) },
